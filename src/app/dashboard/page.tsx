...
const roleKPIs = {
  admin: [
    { id: "patients", icon: "👥", label: "Total Patients", value: "1 240", sub: "+12 aujourd'hui", trend: "+5.2%", up: true, color: "#1a56db", bg: "linear-gradient(135deg, #1a56db, #3b82f6)", light: "#eff6ff" },
    { id: "consultations", icon: "🩺", label: "Consultations", value: "28", sub: "Aujourd'hui", trend: "+3", up: true, color: "#0e9f6e", bg: "linear-gradient(135deg, #0e9f6e, #34d399)", light: "#f0fdf4" },
    { id: "chambres", icon: "🏨", label: "Chambres Libres", value: "12", sub: "sur 45 chambres", trend: "-2", up: false, color: "#7c3aed", bg: "linear-gradient(135deg, #7c3aed, #a78bfa)", light: "#f5f3ff" },
    { id: "medicaments", icon: "💊", label: "Médicaments", value: "320", sub: "En stock", trend: "4 alertes", up: false, color: "#d97706", bg: "linear-gradient(135deg, #d97706, #fbbf24)", light: "#fffbeb" },
    { id: "factures", icon: "💰", label: "Recettes du Jour", value: "45 000 FC", sub: "+8 factures", trend: "+18%", up: true, color: "#059669", bg: "linear-gradient(135deg, #059669, #10b981)", light: "#ecfdf5" },
    { id: "labo", icon: "🔬", label: "Examens Labo", value: "15", sub: "En attente", trend: "+5", up: false, color: "#0891b2", bg: "linear-gradient(135deg, #0891b2, #22d3ee)", light: "#ecfeff" },
  ],
  medecin: [
    { id: "consultations", icon: "🩺", label: "Consultations", value: "28", sub: "Aujourd'hui", trend: "+3", up: true, color: "#0e9f6e", bg: "linear-gradient(135deg, #0e9f6e, #34d399)", light: "#f0fdf4" },
    { id: "patients", icon: "👥", label: "Mes Patients", value: "156", sub: "Total", trend: "+8", up: true, color: "#1a56db", bg: "linear-gradient(135deg, #1a56db, #3b82f6)", light: "#eff6ff" },
    { id: "labo", icon: "🔬", label: "Examens Labo", value: "15", sub: "En attente", trend: "+5", up: false, color: "#7c3aed", bg: "linear-gradient(135deg, #7c3aed, #a78bfa)", light: "#f5f3ff" },
    { id: "hospitalisation", icon: "🏨", label: "Hospitalisés", value: "8", sub: "Sous suivi", trend: "+2", up: true, color: "#d97706", bg: "linear-gradient(135deg, #d97706, #fbbf24)", light: "#fffbeb" },
  ],
  infirmier: [
    { id: "patients", icon: "👥", label: "Patients", value: "45", sub: "Actifs", trend: "+5", up: true, color: "#1a56db", bg: "linear-gradient(135deg, #1a56db, #3b82f6)", light: "#eff6ff" },
    { id: "hospitalisation", icon: "🏨", label: "Hospitalisés", value: "18", sub: "En cours", trend: "-2", up: false, color: "#d97706", bg: "linear-gradient(135deg, #d97706, #fbbf24)", light: "#fffbeb" },
    { id: "medicaments", icon: "💊", label: "Médicaments", value: "320", sub: "En stock", trend: "4 alertes", up: false, color: "#0e9f6e", bg: "linear-gradient(135deg, #0e9f6e, #34d399)", light: "#f0fdf4" },
  ],
  caissier: [
    { id: "factures", icon: "🧾", label: "Factures", value: "18", sub: "Aujourd'hui", trend: "+5", up: true, color: "#059669", bg: "linear-gradient(135deg, #059669, #10b981)", light: "#ecfdf5" },
    { id: "recettes", icon: "💰", label: "Recettes du Jour", value: "45 000 FC", sub: "+18%", trend: "+8 000", up: true, color: "#1a56db", bg: "linear-gradient(135deg, #1a56db, #3b82f6)", light: "#eff6ff" },
    { id: "paiements", icon: "💳", label: "Paiements", value: "12", sub: "Effectués", trend: "+3", up: true, color: "#7c3aed", bg: "linear-gradient(135deg, #7c3aed, #a78bfa)", light: "#f5f3ff" },
  ],
  laborantin: [
    { id: "labo", icon: "🔬", label: "Examens", value: "15", sub: "En attente", trend: "+5", up: true, color: "#7c3aed", bg: "linear-gradient(135deg, #7c3aed, #a78bfa)", light: "#f5f3ff" },
    { id: "resultats", icon: "📋", label: "Résultats", value: "8", sub: "Prêts", trend: "+2", up: true, color: "#0891b2", bg: "linear-gradient(135deg, #0891b2, #22d3ee)", light: "#ecfeff" },
  ],
  pharmacien: [
    { id: "medicaments", icon: "💊", label: "Médicaments", value: "320", sub: "En stock", trend: "4 alertes", up: false, color: "#d97706", bg: "linear-gradient(135deg, #d97706, #fbbf24)", light: "#fffbeb" },
    { id: "alertes", icon: "⚠️", label: "Alertes Stock", value: "4", sub: "Critiques", trend: "-2", up: false, color: "#e02424", bg: "linear-gradient(135deg, #e02424, #f87171)", light: "#fef2f2" },
    { id: "dispenses", icon: "💉", label: "Dispensations", value: "22", sub: "Aujourd'hui", trend: "+8", up: true, color: "#0e9f6e", bg: "linear-gradient(135deg, #0e9f6e, #34d399)", light: "#f0fdf4" },
  ],
};
...
const roleActions = {
  ...
  medecin: [
    { href: "/dashboard/patients", icon: "👤", label: "Patients", color: "#1a56db" },
    { href: "/dashboard/consultations", icon: "🩺", label: "Consultation", color: "#0e9f6e" },
    { href: "/dashboard/laboratoire", icon: "🔬", label: "Examen Labo", color: "#7c3aed" },
    { href: "/dashboard/medicaments", icon: "💊", label: "Ordonnances", color: "#d97706" },
    { href: "/dashboard/hospitalisation", icon: "🏨", label: "Hospitalisation", color: "#e02424" },
  ],
  infirmier: [
    { href: "/dashboard/patients", icon: "👤", label: "Patients", color: "#1a56db" },
    { href: "/dashboard/hospitalisation", icon: "🏨", label: "Hospitalisation", color: "#d97706" },
    { href: "/dashboard/medicaments", icon: "💊", label: "Médicaments", color: "#0e9f6e" },
  ],
  caissier: [
    { href: "/dashboard/factures", icon: "🧾", label: "Nouvelle Facture", color: "#059669" },
    { href: "/dashboard/rapports", icon: "📈", label: "Rapport Journalier", color: "#1a56db" },
  ],
  laborantin: [
    { href: "/dashboard/laboratoire", icon: "🔬", label: "Laboratoire", color: "#7c3aed" },
  ],
  pharmacien: [
    { href: "/dashboard/medicaments", icon: "💊", label: "Médicaments", color: "#d97706" },
    { href: "/dashboard/medicaments", icon: "📦", label: "Mouvements", color: "#0e9f6e" },
  ],
};
...
export default function DashboardPage() {
  ...
  const kpis = roleKPIs[userRole as keyof typeof roleKPIs] || roleKPIs.admin;
  const actions = roleActions[userRole as keyof typeof roleActions] || roleActions.admin;
  const sections = roleSections[userRole as keyof typeof roleSections] || roleSections.admin;
  ...
  return (
    <div className="min-h-screen" style={{ background: "#f0f4f8" }}>
      ...
      <div className="p-5 space-y-5">
        ...
        <div className={`grid gap-4 ${kpis.length <= 3 ? 'grid-cols-1 md:grid-cols-3' : 'grid-cols-2 md:grid-cols-3 xl:grid-cols-' + kpis.length}`}>
          {kpis.map((kpi) => (
        ...
        {/* ── Charts Row ── */}
        {(sections.showConsultations || sections.showRevenue) && (
          <div className="grid md:grid-cols-2 gap-5">
            {sections.showConsultations && (
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        {/* ── Patients + Activity ── */}
        {(sections.showPatients || sections.showActivity) && (
          <div className="grid xl:grid-cols-3 gap-5">
            {sections.showPatients && (
        ...
        {(sections.showRooms || sections.showStock || sections.showOperations) && (
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 flex justify-between text-sm">
                  ...
                  <span className="font-bold text-gray-800">
                    {roomStatus.reduce((s, r) => s + r.occupied, 0)}/{roomStatus.reduce((s, r) => s + r.total, 0)} chambres
                  </span>
                </div>
              </div>
            )}
